...
export const cbQuestions: Question[] = [
  {
    ...
    options: {
      ...
      b: "Các tổ chức kinh doanh mua sắm hàng hóa, dịch vụ để phục vụ trực tiếp cho việc vận hành sản xuất",
      c: "Các đại lý và trung gian thương mại mua sắm sản phẩm với mục đích bán lại để kiếm lợi nhuận",
      d: "Các cơ quan nhà nước và tổ chức phi lợi nhuận mua sắm hàng hóa phục vụ cho lợi ích công cộng"
    },
    correctAnswer: "a",
    chapterId: 1,
    topicId: "CB_T1.1",
    difficulty: "Dễ",
    difficultyRating: 2,
    explanation: "Theo Kotler & Amstrong (2018), hành vi mua của người tiêu dùng là hành vi mua của người tiêu dùng cuối cùng - bao gồm cá nhân và hộ gia đình mua sản phẩm cho mục đích tiêu dùng cá nhân. Các phương án b, c, d sai vì lần lượt mô tả hành vi mua của thị trường tổ chức (doanh nghiệp sản xuất, trung gian thương mại bán lại, cơ quan nhà nước/phi lợi nhuận) chứ không phải người tiêu dùng cuối cùng.",
  ...
  },
  {
    ...
    options: {
      a: "Vì thu nhập của người tiêu dùng luôn biến động liên tục theo thời gian nên các doanh nghiệp chỉ tập trung phân đoạn thị trường dựa trên yếu tố tuổi tác và giới tính",
      ...
      c: "Vì quy định pháp luật hiện hành bắt buộc nhà sản xuất phải bình ổn giá hàng hóa nhằm đảm bảo mọi tầng lớp xã hội đều tiếp cận được các sản phẩm tiêu dùng thiết yếu",
      d: "Vì sự phát triển của công nghệ thông tin đã xóa bỏ hoàn toàn sự khác biệt về văn hóa tiêu dùng giữa các vùng miền và các nhóm dân cư có mức thu nhập khác nhau trong xã hội"
    },
    correctAnswer: "b",
    chapterId: 2,
    topicId: "CB_T2.2",
    difficulty: "Khó",
    difficultyRating: 4,
    explanation: "Giai tầng xã hội được xác định bởi tổng hòa nhiều yếu tố như nghề nghiệp, trình độ học vấn, giá trị sống chứ không riêng thu nhập. Do đó, những cá nhân thuộc các tầng lớp khác nhau dù có cùng mức thu nhập vẫn có chuẩn mực thẩm mỹ và đòi hỏi chất lượng sản phẩm khác biệt. Các phương án a, c, d đều sai vì phương án a đưa ra lý do không chính xác về tiêu chí phân đoạn thị trường, phương án c nhầm lẫn giữa chính sách quản lý nhà nước với hành vi người tiêu dùng, còn phương án d tuyệt đối hóa sai thực tế tác động của công nghệ.",
    sourcePdf: "HanhViKhachHang.pdf",
  ...
  },
  {
    ...
    options: {
      a: "Bản ngã thực tế của cá nhân trong đời sống thường nhật",
      b: "Bản ngã lý tưởng mà cá nhân luôn khao khát đạt tới",
      c: "Bản ngã trong mắt người khác (Looking-glass Self)",
      d: "Nhu cầu sinh lý bẩm sinh của con người trong xã hội"
    },
    correctAnswer: "c",
    chapterId: 3,
    topicId: "CB_T3.3",
    difficulty: "Trung bình",
    difficultyRating: 3,
    explanation: "Hành vi mua sắm sản phẩm cao cấp để thể hiện địa vị và mong muốn người khác đánh giá cao mình xuất phát từ hình ảnh bản thân trong mắt người khác. Phương án a sai vì bản ngã thực tế phản ánh con người thực sự hiện tại chứ không hướng tới đánh giá của xã hội. Phương án b sai vì bản ngã lý tưởng là hình mẫu cá nhân muốn trở thành cho chính mình. Phương án d sai vì nhu cầu sinh lý là những đòi hỏi cơ bản để tồn tại chứ không phải yếu tố thể hiện địa vị.",
    sourcePdf: "HanhViKhachHang.pdf",
  ...
  },
  {
    ...
    options: {
      a: "Tìm kiếm thông tin, đánh giá phương án và đưa ra quyết định tiêu dùng",
      b: "Tiếp nhận (Exposure), chú ý (Attention) và diễn giải (Interpretation)",
      c: "Ghi nhớ ngắn hạn, chuyển đổi dữ liệu và lưu trữ thông tin dài hạn",
      d: "Phân tích nhu cầu cá nhân, so sánh giá sản phẩm và chọn mua tại cửa hàng"
    },
    correctAnswer: "b",
    chapterId: 4,
    topicId: "CB_T4.2",
    difficulty: "Dễ",
    difficultyRating: 2,
    explanation: "Phương án đúng phản ánh chính xác quá trình nhận thức của cá nhân gồm tiếp nhận, chú ý và diễn giải kích thích. Các phương án sai vì: phương án a nhầm sang các bước trong quá trình ra quyết định mua hàng; phương án c nhầm sang các giai đoạn của trí nhớ và lưu trữ thông tin; phương án d nhầm sang hành vi mua sắm thực tế.",
    sourcePdf: "HanhViKhachHang.pdf",
  ...
  },
  {
    ...
    options: {
      ...
      b: "Chú ý -> Quan tâm -> Mong muốn -> Hành động -> Trung thành và lan tỏa giá trị thương hiệu",
      c: "Tiếp xúc ban đầu -> Thử nghiệm sản phẩm -> Mua sắm chính thức -> Đánh giá trải nghiệm -> Trung thành",
      d: "Tìm kiếm thông tin -> So sánh lựa chọn -> Thương thảo hợp đồng -> Nghiệm thu và đánh giá"
    },
    correctAnswer: "a",
    chapterId: 5,
    topicId: "CB_T5.3",
    difficulty: "Dễ",
    difficultyRating: 2,
    explanation: "Hành trình khách hàng thời đại kỹ thuật số 4.0 theo mô hình 5A của Philip Kotler bao gồm 5 bước theo thứ tự: Nhận biết (Aware), Thu hút (Appeal), Tìm hiểu (Ask), Hành động (Act) và Ủng hộ (Advocate). Các phương án sai b, c, d là sai vì mô hình 5A không tuân theo các bước của mô hình truyền thống AIDA, quy trình tiêu dùng 5 bước cổ điển hay quy trình mua sắm trong thương mại B2B.",
    sourcePdf: "HanhViKhachHang.pdf",
  ...
  },
  {
    ...
    options: {
      a: "Cầu hoàn toàn độc lập - không chịu sự tác động hay ảnh hưởng nào từ những biến động của thị trường hàng tiêu dùng",
      b: "Cầu phái sinh (Derived Demand) - bắt nguồn từ nhu cầu về sản phẩm tiêu dùng của người tiêu dùng cuối cùng",
      c: "Cầu có độ co giãn cực kỳ cao theo giá cả - giá biến động nhỏ làm thay đổi toàn bộ lượng cầu mua của tổ chức",
      d: "Số lượng người mua rất đông đảo và phân tán rộng khắp mọi vùng địa lý tương tự thị trường tiêu dùng cá nhân"
    },
    correctAnswer: "b",
    chapterId: 6,
    topicId: "CB_T6.2",
    difficulty: "Trung bình",
    difficultyRating: 3,
    explanation: "Đặc điểm cốt lõi của thị trường tổ chức là cầu phái sinh, tức là nhu cầu mua sản phẩm của tổ chức xuất phát từ nhu cầu đối với các sản phẩm tiêu dùng cuối cùng. Các phương án a, c, d đều sai vì phương án a phủ nhận mối liên hệ giữa nhu cầu tổ chức và tiêu dùng, phương án c nhầm lẫn vì cầu tổ chức thường ít co giãn theo giá trong ngắn hạn, còn phương án d mô tả sai thực tế vì người mua tổ chức thường ít hơn và tập trung hơn về mặt địa lý.",
    sourcePdf: "HanhViKhachHang.pdf",
  ...
  },
  {
    ...
    options: {
      a: "Là người đại diện tổ chức tiến hành đàm phán chính thức, hoàn tất thủ tục pháp lý và ký kết hợp đồng mua sắm hàng hóa trực tiếp với nhà cung ứng",
      b: "Là người trực tiếp vận hành các loại máy móc, trang thiết bị trong quy trình sản xuất và phản hồi ý kiến về chất lượng sản phẩm cho ban quản lý",
      ...
      d: "Là người sở hữu thẩm quyền phê duyệt ngân sách tài chính cuối cùng, quyết định lựa chọn thương hiệu cùng phương thức thanh toán cho toàn dự án"
    },
    correctAnswer: "c",
    chapterId: 7,
    topicId: "CB_T7.3",
    difficulty: "Trung bình",
    difficultyRating: 3,
    explanation: "Đáp án c đúng vì Người gác cửa đóng vai trò kiểm soát luồng thông tin đi vào tổ chức và ngăn cản nhà cung ứng tiếp cận người quyết định. Các phương án sai: a nhầm sang vai trò của người mua; b nhầm sang vai trò của người sử dụng; d nhầm sang vai trò của người quyết định.",
    sourcePdf: "HanhViKhachHang.pdf",
